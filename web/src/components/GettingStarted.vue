...
const steps2 = `
3. check out the [[docs|${env.DOCS_URL}]]
`
...
<template>
  <Page id="getting-started" :marginTop="false">
    <div id="c3" class="d-flex flex-column align-items-center justify-content-center gap-3">
      <div class="d-flex flex-column align-items-center gap-2">

        <CodeBlock lang="md" :source="steps" file="getting-started.md">
          ...
          <CodeBlock lang="md" :titlebar="false" :source="steps2" />
        </CodeBlock>
...
#short {
  text-shadow: 0px 2px 6px var(--color-primary);
}
</style>